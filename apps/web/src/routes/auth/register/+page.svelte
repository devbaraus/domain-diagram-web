...
<div class="flex min-h-screen items-center justify-center self-center">
	<div class="flex flex-col items-stretch p-6 shadow md:p-8 lg:p-16">
		<div role="tablist" class="tabs tabs-bordered">
			<a href={Routes.LOGIN} class="tab text-center text-xl font-semibold">Login</a>
			<a href={Routes.REGISTER} class="tab tab-active text-center text-xl font-semibold">Register</a
			>
		</div>
		<form
			method="post"
